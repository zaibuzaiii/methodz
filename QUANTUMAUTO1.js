...
function runScript() {
    ...
    console.log(`Menjalankan QUANTUM.js untuk ${host} (Elapsed: ${elapsedTime}/${time} detik)...`);

    const command = `node QUANTUM.js ${host} ${Math.min(60, time - elapsedTime)} ${thread} ${rate} ${proxyFile}`;
